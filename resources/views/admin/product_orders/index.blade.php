                ...
                @forelse ($my_orders as $order)
                    <div class="item-product flex flex-row justify-between items-center">
                        ...
                        <div>
                            ...
                            @if ($order->is_paid)
                                <span class="py-1 px-4 rounded-full bg-green-500 text-white font-bold text-sm">
                                    PAID
                                </span>
                            @else
                                <span class="py-1 px-4 rounded-full bg-orange-500 text-white font-bold text-sm">
                                    PENDING
                                </span>
                            @endif
                        </div>
                        <div class="flex flex-row gap-x-3">
                            <a href="{{ route('admin.product_orders.show', $order) }}"
                                class="rounded-full py-3 px-5 bg-indigo-500 text-white font-bold">View Details</a>
